...
CREATE TABLE IF NOT EXISTS oa_works (
    ...
    oa_status      LowCardinality(Nullable(String)),
...
CREATE TABLE IF NOT EXISTS oa_work_topics (
    ...
    subfield   LowCardinality(Nullable(String)),
    field      LowCardinality(Nullable(String)),
...
CREATE TABLE IF NOT EXISTS pm_papers (
    ...
    medline_status LowCardinality(Nullable(String)),
